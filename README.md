...
prepare, then 0.5s per message. The prepared feed retains about 3.5 GB resident,
...
holds roughly 3.5 GB. Reusing one moves staleness onto you, since the archive is
